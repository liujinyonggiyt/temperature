...
public class BltManager {
    ...
    private BroadcastReceiver searchDevices = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            for (int i = 0; i < lstName.length; i++) {
                ...
                MyLog.e("bluetooth", keyName + ">>>" + String.valueOf(b.get(keyName)));
            }
            ...
            //状态改变时
                ...
                switch (device.getBondState()) {
                    case BluetoothDevice.BOND_BONDING://正在配对
                        MyLog.d("BlueToothTestActivity", "正在配对......");
                        onRegisterBltReceiver.onBltIng(device);
                        break;
                    case BluetoothDevice.BOND_BONDED://配对结束
                        MyLog.d("BlueToothTestActivity", "完成配对");
                        onRegisterBltReceiver.onBltEnd(device);
                        break;
                    case BluetoothDevice.BOND_NONE://取消配对/未配对
                        MyLog.d("BlueToothTestActivity", "取消配对");
    ...
    private boolean startSearthBltDevice(Context context) {
        ...
        if (getmBluetoothAdapter().isDiscovering())
            stopSearthBltDevice();
        MyLog.i("bluetooth", "本机蓝牙地址：" + getmBluetoothAdapter().getAddress());
        //开始搜索
